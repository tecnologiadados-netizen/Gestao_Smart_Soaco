...
export const ROTA_PERMISSAO: Record<string, CodigoPermissao[]> = {
  ...
  '/suporte/amigaco-alucinacoes': [PERMISSOES.ASSISTENTE_ALUCINACOES_VER],
  ...
  '/rh/faltas-atestados': [PERMISSOES.RH_VER],
  '/rh/cargos': [PERMISSOES.RH_VER],
  '/rh/organograma': [PERMISSOES.RH_VER],
  '/rh/configuracoes': [PERMISSOES.RH_VER, PERMISSOES.RH_CONFIGURAR],
  ...
  '/integracao/assistente-ia': [PERMISSOES.SISTEMA_AI, PERMISSOES.USUARIOS_GERENCIAR],
...
export const ROTAS_ORDEM = [
  ...
  '/compras/pre-compra',
  '/compras/painel-rupturas',
  '/compras/double-checkin',
