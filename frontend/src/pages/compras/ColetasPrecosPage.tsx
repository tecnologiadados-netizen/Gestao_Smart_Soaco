  ...
  return (
    <div className="space-y-6">
      ...
      {popupBloqueio && popupBloqueio.length > 0 && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75" onClick={() => setPopupBloqueio(null)} role="dialog" aria-modal="true" aria-labelledby="modal-bloqueio-title">
      ...
      {coletaCiencia && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75" role="dialog" aria-modal="true" aria-labelledby="modal-ciencia-title">
      ...
      {coletaToExcluir && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75" onClick={() => { if (!excluindoColetaId) { setColetaToExcluir(null); setErroExcluirColeta(null); } }} role="dialog" aria-modal="true" aria-labelledby="modal-excluir-coleta-title">
          <div
      ...
      {alertaPrecosSemFornecedor && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75" onClick={() => setAlertaPrecosSemFornecedor(null)} role="dialog" aria-modal="true">
          <div
