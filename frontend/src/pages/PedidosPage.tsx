...
export default function PedidosPage() {
  ...
  return (
    <div className="flex min-h-0 w-full min-w-0 flex-1 flex-col gap-4" style={{ width: '100%', maxWidth: '100%' }}>
      ...
      {toast && (
        <div className="fixed bottom-4 right-4 z-[160] rounded-lg bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 px-4 py-2 text-slate-800 dark:text-slate-100 shadow-lg">
          {toast}
        </div>
      )}
    </div>
