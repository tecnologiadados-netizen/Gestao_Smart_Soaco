...
type Props = {
  ...
  modalId: string;
  onClose: () => void;
  onTipoFClick: (item: TipoFValorResumo) => void;
  fetchData: () => Promise<TipoFValorResumo[]>;
};

export default function ModalDashEntregasTipoFChart({
  open,
  titulo,
  subtitulo,
  modalId,
  ...
  const [dados, setDados] = useState<TipoFValorResumo[]>([]);
