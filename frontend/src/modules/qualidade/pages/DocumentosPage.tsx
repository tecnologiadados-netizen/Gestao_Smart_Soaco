...
import { DocumentosPendenciasBoards } from "@qualidade/components/documentos/documentos-pendencias-boards";
    ...
    <div className="space-y-6">
      ...
      {!showAll && (
        <p className="text-left text-xs text-muted-foreground">
          ...
          <Link to="/qualidade/documentos/consulta" className="text-primary underline">
            Ir para consulta
          </Link>
        </p>
      )}
