import historicoRncJson from "@/lib/mock-data/rnc-historico-nomus.json";
import historicoRccJson from "@/lib/mock-data/rcc-historico-nomus.json";
import type { Registro } from "@/types/registro";
import { getRegistroDataOcorrencia } from "@/types/registro";
